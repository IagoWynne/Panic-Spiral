...
class ScoreEvents {
  ...
  private _scoreIncrementStartedEventHandlers: ScoreIncrementChangedEventHandler[] =
    [];
  private _scoreMultiplierChangedEventHandlers: ScoreMultiplerChangedEventHandler[] =
    [];
  ...
  public addScoreMultiplierChangedListener(
    ...
    this._scoreMultiplierChangedEventHandlers.push(eventHandler);
  }

  public removeScoreMultiplierChangedListener(componentId: string) {
    this.removeListener(componentId, this._scoreMultiplierChangedEventHandlers);
  }
  ...
  public onScoreMultiplierChanged(newMultipler: number) {
    this._scoreMultiplierChangedEventHandlers.forEach((handler) =>
  ...
  public release() {
    ...
    this._scoreMultiplierChangedEventHandlers = [];
  }
}

const scoreEvents = new ScoreEvents();
